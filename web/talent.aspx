<%@ Page Language="C#" AutoEventWireup="true" CodeFile="talent.aspx.cs" Inherits="talent" %>
...
<head runat="server">
    <title>人才招聘</title><link href="style/main.css" type="text/css" rel="stylesheet" />
</head>
<body class="other_body">
    ...
    <div id="position">
        <p>
            &nbsp;当前位置：<a href="/" class="agray">首页</a> - 人才招聘
        </p>
    </div>
    <div id="content">
                    ...
                    <ItemTemplate>
                        <tr style="height: 28px;">
                            <td style="background: url(/images/bg2.gif) repeat-x left bottom;">
                                &nbsp;<img src="/images/title.jpg" width="4" height="8" align="absmiddle" />&nbsp;&nbsp;<a class="a-link" href="/article_detail1.aspx?id=<%# Eval("aid") %>"><%# Eval("title") %></a></td>
