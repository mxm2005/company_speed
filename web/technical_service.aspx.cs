...
public partial class technical_service : System.Web.UI.Page
{
    ...
    private void InitArgs()
    {
        ...
        mTypeId = int.Parse(ConfigurationManager.AppSettings["technical"]);
    }
    ...
    private void SetBanner()
    {
        ...
        topBanner.Src = Banner.GetBannerImg("technical", path);
    }
}
