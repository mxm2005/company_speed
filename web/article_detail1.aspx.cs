...
public partial class article_detail1 : System.Web.UI.Page
{
    int _aid = 0;
    ...
    private void ShowPreNext(int type)
    {
        ...
        if (mo != null)
        {
            tdLink.InnerHtml = "上一篇：<a class='a-link' href=\"article_detail1.aspx?id=" + mo.aid + "\">" +
                mo.title + "</a>";
        }
        else
        {
        ...
        if (mo != null)
        {
            tdLink.InnerHtml += "<br />下一篇：<a class='a-link' href=\"article_detail1.aspx?id=" + mo.aid + "\">" +
                mo.title + "</a>";
        }
        else
        {
