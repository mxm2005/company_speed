<%@ Page Language="C#" AutoEventWireup="true" CodeFile="banner_index.aspx.cs" Inherits="admin_banner_index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>首页广告设置Banner</title>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr class="tr_light">
                    ...
                    <td>
                        <asp:TextBox ID="txtUrl" runat="server" Width="300" Text='<%# Eval("url")%>'></asp:TextBox>
                    </td>
                    <%--<td>                        
